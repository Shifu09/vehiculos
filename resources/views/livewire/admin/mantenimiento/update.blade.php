<div class="card">
    <div class="card-header p-0">
        ...
        <div class="px-2 mt-4">
            <ul class="breadcrumb mt-3 py-3 px-4 rounded">
                ...
                <li class="breadcrumb-item"><a href="@route(getRouteName().'.mantenimiento.read')" class="text-decoration-none">{{ __(\Illuminate\Support\Str::plural('Mantenimiento')) }}</a></li>
    ...
    <form class="form-horizontal" wire:submit.prevent="update" enctype="multipart/form-data">
        ...
        <div class="card-body">
            ...
            <!-- Tipo Input -->
            <div class='form-group'>
                <label for='input-tipo' class='col-sm-2 control-label '> {{ __('Tipo') }}</label>
                <select id='input-tipo' wire:model.lazy='tipo' class="form-control  @error('tipo') is-invalid @enderror">
