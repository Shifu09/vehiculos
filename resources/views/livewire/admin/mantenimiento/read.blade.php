    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header p-0">
                <h3 class="card-title">
                    {{ __('ListTitle', ['name' => __(\Illuminate\Support\Str::plural('Mantenimiento'))]) }}</h3>
                ...
                <div class="px-2 mt-4">
                    ...
                    <ul class="breadcrumb mt-3 py-3 px-4 rounded">
                        ...
                        <li class="breadcrumb-item active">{{ __(\Illuminate\Support\Str::plural('Mantenimiento')) }}
                        </li>
                    </ul>
                    ...
                    <div class="row justify-content-between mt-4 mb-4">
                        @if (getCrudConfig('Mantenimiento')->create && hasPermission(getRouteName() . '.mantenimiento.create', 0, 0))
                            <div class="col-md-4 right-0">
                                <a style="border-radius: 13px" href="@route(getRouteName() . '.mantenimiento.create')"
