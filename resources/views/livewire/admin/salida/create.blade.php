<div class="card">
    <div class="card-header p-0">
        <h3 class="card-title">{{ __('CreateTitle', ['name' => __('Salida')]) }}</h3>
        <div class="px-2 mt-4">
            <ul class="breadcrumb mt-3 py-3 px-4 rounded">
                <li class="breadcrumb-item"><a href="@route(getRouteName() . '.home')"
                        class="text-decoration-none">{{ __('Dashboard') }}</a></li>
                <li class="breadcrumb-item"><a href="@route(getRouteName() . '.salida.read')"
                        class="text-decoration-none">{{ __(\Illuminate\Support\Str::plural('Salida')) }}</a></li>
    ...
    <form class="form-horizontal" wire:submit.prevent="create" enctype="multipart/form-data">
        ...
        <div class="card-body">
            ...
            <div class='form-group'>
                ...
                <input type='text' id='input-destino' wire:model.lazy='destino'
                    class="form-control  @error('destino') is-invalid @enderror" placeholder='' autocomplete='on'>
                @error('destino')
                    <div class='invalid-feedback'>{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class='form-group'>
                ...
                <input type='text' id='input-kilometraje' wire:model.lazy='kilometraje'
                    class="form-control  @error('kilometraje') is-invalid @enderror" placeholder='' autocomplete='on'>
                @error('kilometraje')
                    <div class='invalid-feedback'>{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class='form-group'>
                ...
                <input type='datetime-local' id='input-fecha' wire:model.lazy='fecha'
