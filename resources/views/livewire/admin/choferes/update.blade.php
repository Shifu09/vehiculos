<div class="card">
    <div class="card-header p-0">
        <h3 class="card-title">{{ __('UpdateTitle', ['name' => __('Choferes') ]) }}</h3>
        <div class="px-2 mt-4">
            <ul class="breadcrumb mt-3 py-3 px-4 rounded">
                <li class="breadcrumb-item"><a href="@route(getRouteName().'.home')" class="text-decoration-none">{{ __('Dashboard') }}</a></li>
                <li class="breadcrumb-item"><a href="@route(getRouteName().'.choferes.read')" class="text-decoration-none">{{ __(\Illuminate\Support\Str::plural('Choferes')) }}</a></li>
    ...
    <form class="form-horizontal" wire:submit.prevent="update" enctype="multipart/form-data">
        ...
        <div class="card-body">
            ...
            <div class='form-group'>
                ...
                <input type='text' id='input-apellido' wire:model.lazy='apellido' class="form-control  @error('apellido') is-invalid @enderror" placeholder='' autocomplete='on'>
