                    ...
                    <div class="row justify-content-between mt-4 mb-4">
                        @if (getCrudConfig('Vehiculos')->create && hasPermission(getRouteName() . '.vehiculos.create', 1, 1))
                            <div class="col-md-4 right-0">
                                <a href="@route(getRouteName() . '.vehiculos.create')"
                    ...
                    <thead>
                        <tr>
                            ...
                            <th scope="col" style='cursor: pointer' wire:click="sort('marca')"> <i
                                ...
                                {{ __('Marca') }} </th>
                            <th scope="col" style='cursor: pointer' wire:click="sort('moelo')"> <i
                                    class='fa @if ($sortType == 'desc' and $sortColumn == 'moelo') fa-sort-amount-down ml-2 @elseif($sortType == 'asc' and $sortColumn == 'moelo') fa-sort-amount-up ml-2 @endif'></i>
                                {{ __('Modelo') }} </th>
